    ...
    <FantasyShell className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-start">
      ...
      <div className="lg:col-span-5 flex flex-col items-center gap-6">
        {!isConnected ? (
          ...
          <button onClick={() => setShowCollectionPanel(true)} className="group relative w-full max-w-[430px]">
            <div className="absolute inset-0 rounded-full bg-blue-300/20 blur-3xl" />
            <img
              src={uiAssets.crystal}
              alt="Crystal pile"
              className="relative z-10 w-full object-contain drop-shadow-[0_15px_40px_rgba(59,130,246,0.35)] transition-transform duration-300 group-hover:scale-[1.03]"
            />
            <p className="cinzel mt-3 text-center text-lg font-bold uppercase tracking-[0.3em] text-[#8b6914]">Click to Collect</p>
          </button>
        )}
      </div>
